...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.migrations.engine' => 'string',
            'database.migrations.charset' => 'string',
            'database.migrations.collation' => 'string',
            ...
            'filesystems.links.C:\Users\Abdal\OneDrive\Desktop\PangAIaShop-BackEnd\public\storage' => 'string',
...
'database.connections.mysql.username','database.connections.mysql.password','database.connections.mysql.engine','database.connections.mysql.charset','database.connections.mysql.collation',
'database.connections.mysql.unix_socket','database.connections.mysql.prefix','database.connections.mysql.prefix_indexes','database.connections.mysql.strict','database.connections.mysql.options',
...
'database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.migrations.table','database.migrations.engine','database.migrations.charset',
'database.migrations.collation','database.migrations.update_date_on_publish','database.redis.client','database.redis.options.cluster','database.redis.options.prefix',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Abdal\\OneDrive\\Desktop\\PangAIaShop-BackEnd\\public\\storage',
...
'signed','throttle','verified','admin','admin.access',
'superadmin.access','admin.record.access',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','admin.login','products.index',
'products.store','products.show','products.update','products.destroy','categories.index','categories.store','categories.show','categories.update',
'categories.destroy','orders.index','orders.store','orders.show','orders.update',
'orders.destroy','inventory.index','inventory.store','inventory.show',
'inventory.update','inventory.destroy','users.index','users.store','users.show',
'users.update','users.destroy','promo-codes.index','promo-codes.store','promo-codes.show',
'promo-codes.update','promo-codes.destroy','support-tickets.index','support-tickets.store','support-tickets.show',
'support-tickets.update','support-tickets.destroy','vendors.index','vendors.store','vendors.show',
'vendors.update','vendors.destroy','home','about','contact','contact.submit',
'shop','product.show','cart','cart.add','cart.update',
'cart.remove','apply.coupon','checkout','checkout.process','news',
'news.show','news.comment','subscribe','login',
'register','password.request','password.email','logout',
'profile','profile.update','password.change','password.update','orders',
'orders.show','orders.cancel','orders.track','wishlist','wishlist.add',
'wishlist.remove','wishlist.move_to_cart','storage.local',);
        registerArgumentsSet('views', 
'admin.admins.create','admin.admins.edit','admin.admins.index','admin.admins.show','admin.audit-logs.index',
'admin.audit-logs.show','admin.auth.login','admin.customers.create','admin.customers.index','admin.dashboard',
'admin.dashboard.index','admin.layouts.app','admin.layouts.navigation','admin.orders.pending','admin.products.create',
'admin.products.edit','admin.products.index','admin.products.inventory','admin.products.show','admin.products.trash',
'admin.profile.index','admin.promotions.discounts','admin.promotions.promo-codes','admin.reports.inventory','app',
'frontend.layouts.master','frontend.pages.404','frontend.pages.about','frontend.pages.cart','frontend.pages.checkout',
'frontend.pages.contact','frontend.pages.home','frontend.pages.news','frontend.pages.shop','frontend.pages.single-news',
'frontend.pages.single-product','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
